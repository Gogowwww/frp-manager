...
“”“Lit la version du panel depuis state.json (mise à jour par auto-update).”””
try:
...
if not _DOCKER_SOCK.exists():
return {}
status, containers = *docker_api(“GET”, “/containers/json?all=true”)
...
arch     = get_arch()
filename = f”frp_{version}*linux*{arch}.tar.gz”
